...
这套文档记录 **Moxie** 的架构、功能实现方式、开发/打包流程，以及开发过程中发现并修复的关键问题与设计决策。

> Moxie 是一款温暖、现代的 Markdown 编辑器 —— 一个 Typora 替代品，核心理念：**每个文件都在同一个窗口里作为标签页打开**，而不是新开一个程序。
...
| [typora-style-menubar-plan.md](./typora-style-menubar-plan.md) | 顶部 Typora 风格菜单栏的 UI、菜单结构、现有能力映射和后续开发方案 |
